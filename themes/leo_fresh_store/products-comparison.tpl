		...
		<table id="product_comparison" class="table table-bordered">
			<tr>
				...
				{foreach from=$products item=product name=for_products}
					...
					<td class="ajax_block_product product-container comparison_infos product-block product-{$product->id}">
						<div class="remove">
						...
						<div class="product-image-container image">
							...
							{if isset($product->new) && $product->new == 1}
								<a class="product-box new-box" href="{$product->getLink()|escape:'html':'UTF-8'}">
									<span class="new-label product-label label">{l s='New'}</span>
								</a>
							{/if}

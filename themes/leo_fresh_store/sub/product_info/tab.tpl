						...
						<div class="product_list grid row">
							{foreach from=$accessories item=accessory name=accessories_list}
								{if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
									...
									<div class="product_block col-xs-12 col-sm-6 col-md-4 col-lg-3 item ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
										<div class="product-container product-block text-center" itemscope itemtype="https://schema.org/Product">
											<div class="left-block">
												<div class="product-image-container image">
													...
													{if isset($quick_view) && $quick_view}
														<div class="btn-small">
															<a class="quick-view btn" href="{$accessory.link|escape:'html':'UTF-8'}" rel="{$accessory.link|escape:'html':'UTF-8'}" data-original-title="{l s='Quick view'}">
											...
											<div class="right-block">
												...
												<div class="functional-buttons clearfix">	
													<div class="view">
														<a itemprop="url" class="lnk_view btn" href="{$accessory.link|escape:'html':'UTF-8'}" title="{l s='View'}">
															<span>{l s='More'}</span><i class="fa fa-info"></i>
														</a>
													</div>

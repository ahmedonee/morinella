						...
						<div class="product_list grid row">
							{foreach from=$accessories item=accessory name=accessories_list}
								{if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
									...
									<div class="ajax_block_product col-xs-12 col-sm-6 col-md-3 col-lg-3">
											...
											<div class="right-block">
												...
												<div class="functional-buttons clearfix">
													...
													{if isset($comparator_max_item) && $comparator_max_item}		
														<div class="compare btn-small">		
															<a class="add_to_compare btn" href="{$accessory.link|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product}" title="{l s='Add to compare'}" >

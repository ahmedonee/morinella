		...
		<div class="product-image-container image">
		   <div class="leo-more-info" data-idproduct="{$product.id_product}"></div>
			<a class="product_img_link"	href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url">
				...
				<div class="btn-small ">		
					<a class="btn quick-view " href="{$product.link|escape:'html':'UTF-8'}" data-link="{$product.link|escape:'html':'UTF-8'}" >
			...
			{if isset($product.new) && $product.new == 1}	
				<a class="product-box new-box" href="{$product.link|escape:'html':'UTF-8'}" >
					<span class="label">{l s='New'}</span>	
				</a>
			{/if}
			{if isset($product.on_sale) && $product.on_sale && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE}
				<a class="product-box sale-box"  href="{$product.link|escape:'html':'UTF-8'}">
